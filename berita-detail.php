...
<div class="max-w-7xl mx-auto px-4 md:px-6 py-8">
  ...
  <div class="grid lg:grid-cols-3 gap-8">
    ...
    <!-- CTA -->
      <div class="sidebar-card bg-gradient-to-br from-green-300 to-emerald-300 p-6 rounded-2xl shadow-lg">
        <h3 class="text-gray-900 text-xl font-bold mb-3">📢 Informasi PMB</h3>
        <p class="mb-4 text-sm font-medium text-gray-800">
          Pendaftaran Peserta Didik Baru tahun ajaran 2025/2026 telah dibuka!
        </p>
        <a href="<?= url('kontak.php#daftar') ?>" 
          class="block w-full text-center px-6 py-3 bg-white text-green-600 font-bold rounded-full hover:bg-gray-100 transition-all">
          Daftar Sekarang
        </a>
      </div>
