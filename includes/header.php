  ...
  <nav class="sticky top-0 z-50 bg-white/90 backdrop-filter backdrop-blur border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex items-center justify-between h-16">
        <a href="<?= url('index.php') ?>" class="flex items-center">
          <img src="<?php echo $base_url; ?>assets/img/logo.png" alt="ISR" class="h-10 w-auto object-contain">
        </a>
        <div class="hidden md:flex items-center gap-6">
          <a class="text-sm font-medium text-gray-600 hover:text-gray-900" href="<?= url('index.php') ?>">Beranda</a>
            ...
            <div class="dropdown-menu hidden absolute mega-menu mt-2 bg-white rounded-lg shadow-2xl border border-gray-200 p-6">
              <div class="grid grid-cols-3 gap-8">
                ...
                <div class="mega-menu-section">
                  ...
                  <a href="<?= url('profil.php') ?>" class="mega-menu-link">Sejarah Singkat</a>
                ...
                <div class="mega-menu-section">
                  ...
                  <a href="<?php echo $base_url; ?>render-art.php" class="mega-menu-link">Event Sekolah</a>
          ...
          <a class="text-sm font-medium text-gray-600 hover:text-gray-900" href="<?= url('visi-misi.php') ?>">Visi &amp; Misi</a>
          <a class="text-sm font-medium text-gray-600 hover:text-gray-900" href="<?= url('kegiatan.php') ?>">Kegiatan</a>
          <a class="text-sm font-medium text-gray-600 hover:text-gray-900" href="<?= url('galery.php') ?>">Galeri</a>
          ...
          <div class="relative dropdown">
            ...
            <div class="dropdown-menu hidden absolute left-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-200 py-2">
              <a class="block px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-100" href="https://tk.isr.solusidigitalacademy.com/">TK</a>
              <a class="block px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-100" href="https://sd.isr.solusidigitalacademy.com/">SD</a>
    ...
    <div id="mnav" class="md:hidden hidden border-t border-gray-200">
      <div class="max-w-7xl mx-auto px-4 py-2 space-y-2 text-sm">
        ...
        <div>
          ...
          <div id="mobileProfilMenu" class="hidden pl-4 space-y-1 bg-gray-50 rounded-lg p-3 mt-2">
            <div class="mb-3">
              ...
              <a class="block py-1.5 text-sm" href="<?= url('profil.php') ?>">Sejarah Singkat</a>
            ...
            <div class="mb-3">
              ...
              <a class="block py-1.5 text-sm" href="<?php echo $base_url; ?>render-art.php">Event Sekolah</a>
            </div>
        ...
        <a class="block py-2" href="<?= url('visi-misi.php') ?>">Visi &amp; Misi</a>
        <a class="block py-2" href="<?= url('kegiatan.php') ?>">Kegiatan</a>
        <a class="block py-2" href="<?= url('galery.php') ?>">Galeri</a>
        ...
        <div>
          ...
          <div id="mobileJenjang" class="hidden pl-4 space-y-1 mt-2">
            <a class="block py-2 font-medium" href="https://tk.isr.solusidigitalacademy.com/">TK</a>
            ...
            <a class="block py-2 font-medium" href="https://sma.isr.solusidigitalacademy.com/">SMA</a>
          </div>
        </div>
        
        <a class="block py-2 text-center rounded-xl border border-gray-300 mt-4" href="<?= url('kontak.php') ?>">Kontak</a>
