  ...
  <div class="space-y-3">
    <?php
      ...
      foreach ($categories as $cat => $info):
        ...
        $activeClass = ($category === $cat) ? 'bg-green-50 border-2 border-green-600' : 'border-2 border-transparent';
    ?>
      <a href="berita.php?category=<?= $cat ?>" 
         class="flex items-center justify-between p-3 rounded-lg hover:bg-green-50 transition-colors <?= $activeClass ?>">
